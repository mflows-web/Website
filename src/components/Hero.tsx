...
export default function Hero() {
  ...
  return (
    <section className="relative" aria-label="The Mersey Flows hero">
      {/* Mobile: compact hero with logo image and down button, no extra space */}
      {isMobile ? (
        <>
        ...
        <div className="relative overflow-hidden min-h-screen">
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6 min-h-screen flex items-end">
      ...
      {/* Thin accent bar under hero (desktop only — mobile divider is rendered above) */}
      {!isMobile && (
        <div className="h-2 w-full bg-gradient-to-r from-white via-[#cf142b] to-white shadow-[0_0_10px_rgba(207,20,43,0.35)]" />
      )}
    </section>
